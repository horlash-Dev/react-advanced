...
const [emailInput, dispatchEmail] = useReducer(emailAction,{ value: '', isValid: null})
const [passwordInput, dispatchPassword] = useReducer(passwordAction,{ value: '', isValid: null})
